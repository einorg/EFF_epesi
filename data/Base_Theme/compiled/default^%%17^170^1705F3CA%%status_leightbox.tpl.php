<?php /* Smarty version 2.6.29, created on 2020-05-21 11:29:15
         compiled from Effect/Projects/Positions/status_leightbox.tpl */ ?>
<center>
<br>
...
<table id="CRM_Filters" cellspacing="0" cellpadding="0">
	<tr>
        <td id="position_status_new_button">
			<?php echo $this->_tpl_vars['mark_new']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/mark_as_new.png" alt="" align="middle" border="0" width="32" height="32">
        ...
        <td id="position_status_reopen_button">
			<?php echo $this->_tpl_vars['reopen']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/reopen.png" alt="" align="middle" border="0" width="32" height="32">
        ...
        <td id="position_status_in_progress_button">
			<?php echo $this->_tpl_vars['in_progress']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/in_progress.png" alt="" align="middle" border="0" width="32" height="32">
        ...
        <td id="position_status_on_hold_button">
			<?php echo $this->_tpl_vars['on_hold']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/on_hold.png" alt="" align="middle" border="0" width="32" height="32">
        ...
        <td id="position_status_resolve_button">
			<?php echo $this->_tpl_vars['resolve']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/resolved.png" alt="" align="middle" border="0" width="32" height="32">
        ...
        <td id="position_status_feedback_button">
			<?php echo $this->_tpl_vars['feedback']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/feedback.png" alt="" align="middle" border="0" width="32" height="32">
        ...
        <td id="position_status_close_button">
			<?php echo $this->_tpl_vars['close']['open']; ?>

			<div class="epesi_big_button">
				<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/Effect/Projects/Positions/closed.png" alt="" align="middle" border="0" width="32" height="32">
