<?php /* Smarty version 2.6.29, created on 2020-10-27 09:16:28
         compiled from Base/Acl/edit_permissions.tpl */ ?>
	...
	<table>
		<tr>
			<td class="epesi_label" style="width:20%;">
				<?php echo $this->_tpl_vars['form_data']['permission']['label']; ?>

			</td>
			<td class="epesi_data" style="width:80%;">
				<div style="position: relative;">
					<?php echo $this->_tpl_vars['form_data']['permission']['error']; ?>

					&nbsp;&nbsp;<?php echo $this->_tpl_vars['form_data']['permission']['html']; ?>
...
">
				...
				<?php endfor; endif; ?>
				<div id="add_clearance" style="display: inline-block;" class="button" onclick="base_acl__add_clearance();"><?php echo $this->_tpl_vars['labels']['add_clearance']; ?>
</div>
			</td>
		</tr>
	</table>
